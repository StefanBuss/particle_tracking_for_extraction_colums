...
def display_instances(image, boxes, masks, class_ids, class_names,
                      ...
                      save_img=False, save_dir=None, img_name=None, number_saved_images=None):     # Dennis: save-function implemented
    """
    ...
    if save_img:
        ...
        if (choose <=1 ):
            plt.savefig(os.path.join(save_dir, img_name),bbox_inches='tight', pad_inches=False,orientation= 'landscape')   # Dennis: image with detection save
