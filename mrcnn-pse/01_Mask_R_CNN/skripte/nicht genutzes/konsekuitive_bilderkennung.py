...
list_konti_dispers_hold_up = {"20221124_Oben_1,2_1_40": [0.1876 / 60000, 0.1574 / 60000, 7.5 / 100] , "20221124_Oben_1,2_1_80": [0.371 / 60000, 0.31 / 60000, 12.6 / 100],
                      "20221124_Oben_1,2_1_90": [0.414 / 60000, 0.339 / 60000, 16.9 / 100], "20221124_Oben_1,2_1_100": [None, None, None],
                      "20221124_Unten_1,2_1_40": [0.1876 / 60000, 0.1574 / 60000, 7.5 / 100], "20221124_Unten_1,2_1_80": [0.371 / 60000, 0.31 / 60000, 12.6 / 100],
                      "20221124_Unten_1,2_1_90": [0.414 / 60000, 0.339 / 60000, 16.9 / 100], "20221124_Unten_1,2_1_100": [None, None, None],
                      ...
                      "20221125_Oben_3_1_100_ET_250": [None,None,None], "20221125_Oben_3_1_100_ET_500": [None,None,None],
                      "20221125_Unten_3_1_40": [0.21/60000, 0.075/60000, 8.75 / 100], "20221125_Unten_3_1_80": [0.444/60000, 0.145/60000, 14.3 / 100],
                      "20221125_Unten_3_1_90": [0.472/60000, 0.157/60000, 17.5 / 100], "20221125_Unten_3_1_100": [None,None,None],

                      "20221129_Oben_1_2_40": [0.09/60000, 0.185/60000, 4.5 / 100], "20221129_Oben_1_2_80": [0.18/60000, 0.359/60000, 7.5 / 100],
                      "20221129_Oben_1_2_90": [0.203/60000, 0.405/60000, 8.75 / 100], "20221129_Oben_1_2_100": [None,None,None],
                      "20221129_Unten_1_2_40": [0.09/60000, 0.185/60000, 4.5 / 100], "20221129_Unten_1_2_80": [0.18/60000, 0.359/60000, 7.5 / 100],
                      "20221129_Unten_1_2_90": [0.203/60000, 0.405/60000, 8.75 / 100], "20221129_Unten_1_2_100": [None,None,None],
                                 
                      "20221130_Oben_1,2_1_40": [0.188/60000, 0.154/60000, 7.5 / 100], "20221130_Oben_1,2_1_80": [0.37/60000, 0.305/60000, 12.6 / 100],
                      "20221130_Oben_1,2_1_90": [0.407/60000, 0.335/60000, 16.9 / 100], "20221130_Oben_1,2_1_100": [None,None,None],
                      "20221130_Unten_1,2_1_40": [0.188/60000, 0.154/60000, 7.5 / 100], "20221130_Unten_1,2_1_80": [0.37/60000, 0.305/60000, 12.6 / 100],
                      "20221130_Unten_1,2_1_90": [0.407/60000, 0.335/60000, 16.9 / 100], "20221130_Unten_1,2_1_100": [None,None,None]}
...
#python C:\\Users\\stefa\\Desktop\\BA_git\\mrcnn-pse\\01_Mask_R_CNN\\skripte\\konsekuitive_bilderkennung_umgedrehtes_koordinatensystem.py
...
def konsekutive_bilderverfolgung():
    ...
    for bild_index in range(start, ende):
        ...
        #Hier wird sortiert zwischen Potentiellen Nachfolger Beziehungen bei denen ein Vorgänger mehrere potentielle Nachfolger Bezeihungen hat und den übrigen potentiellen vorgänger nachfolger beziehungen
        ...
        #Hier werden die wahrscheinlichsten Nachfolgern berechnet für alle potentielle Vorgänger Nachfolger Beziehungen bei denen ein Vorgänger mehrere Nachfolger haben kann 
        ...
        #print(wahrscheinlichsten_vorgänger_nachfolger_beziehungen)
        list_komb.append(wahrscheinlichsten_vorgänger_nachfolger_beziehungen)

        #for elem in list_komb:
        #    print(elem)
        #input("press")
...
def plot_funktion(x_achse, y_achse, y_label, x_label, SAVE_DIR, unteres_y_lim, oberes_y_lim, title):
    ...
    axs.set_ylabel(y_label, fontsize = 18, fontname = "Arial")
    axs.set_xlabel(x_label, fontsize = 18, fontname = "Arial")
    axs.set_title(title, fontsize = 18, fontname = "Arial")
...
def plot_bar(loc_label,label, pos_string,strings, x_achse, y_achse, y_modell, y_label, x_label, title, SAVE_DIR):
    ...
    ax.set_xlabel(x_label, fontsize = 18, fontname = "Arial")
    ax.set_ylabel(y_label, fontsize = 18, fontname = "Arial")
    ax.set_title(title, fontsize = 18, fontname = "Arial")
    ax.tick_params(direction="in")
    
    for i, string in enumerate(strings):
        ax.text(pos_string[0], pos_string[1] - i * 0.05, string, ha='left', va='top', transform=plt.gca().transAxes, fontsize = 18)
    ...
    if x_achse == list_verwendete_daten:
        plt.xticks(rotation=45, ha='right', fontsize = 14, fontname = "Arial")
    else:
        plt.xticks(rotation=45, ha='right', fontsize = 18, fontname = "Arial")
...
def plot_size_distribution(): 
    ...
    plot_bar(loc_label = None, label = None,pos_string = [0.65,0.93], strings = ["summe anzahl ID aus dic_id: " + str(sum(anzahl_tropfen))], x_achse = x, y_achse = anzahl_tropfen, y_modell =  None, y_label = 'Anzahl ID aus dic_id', x_label = 'Tropfengröße [mm]', title = VERWENDETE_DATEN,SAVE_DIR = ROOT_DIR + "\\datasets\\output_analyseddata\\" + VERWENDETE_DATEN + "\\v_y_positive_negative_all_anzahl_tropfen\\anzahl_tropfen_"+VERWENDETE_DATEN)
    ...
    if VERWENDETE_DATEN.split("_")[4] != "100": 
        plot_bar(loc_label = "upper left", label = "gemessene Aufstiegsgeschwindigkeit je Tropfengröße", pos_string = [], strings = [],x_achse = x, y_achse = v_y, y_modell = [y_modell_n, y_modell_n_ges, "Aufstiegsgeschwindigkeit mittels Modell (Parametriserung dieses Datensatzes) n = " + str(np.round(n,2)), "Aufstiegsgeschwindigkeit mittels Modell (Gesamt-Parametrisierung) n = " + str(np.round(n_ges,2))], y_label = 'Aufstiegsgeschwindigkeit [mm/s]', x_label = 'Tropfengröße [mm]',title = VERWENDETE_DATEN, SAVE_DIR = ROOT_DIR + "\\datasets\\output_analyseddata\\" + VERWENDETE_DATEN + "\\v_y_positive_negative_all_anzahl_tropfen\\v_y_parametrisiert_"+VERWENDETE_DATEN)
        plot_bar(loc_label = "upper left", label = "gemessene Aufstiegsgeschwindigkeit je Tropfengröße", pos_string = [], strings = [],x_achse = x, y_achse = v_y, y_modell = [y_modell_n, y_inf,  "Aufstiegsgeschwindigkeit mittels Modell (Parametriserung dieses Datensatzes) n = " + str(np.round(n,2)), "v_inf"], y_label = 'Aufstiegsgeschwindigkeit [mm/s]', x_label = 'Tropfengröße [mm]',title = VERWENDETE_DATEN, SAVE_DIR = ROOT_DIR + "\\datasets\\output_analyseddata\\" + VERWENDETE_DATEN + "\\v_y_positive_negative_all_anzahl_tropfen\\v_y_parametrisiert_v_inf_"+VERWENDETE_DATEN)
    plot_bar(loc_label = "upper left", label = None, pos_string = [], strings = [],x_achse = x, y_achse = v_y, y_modell = None, y_label = 'Aufstiegsgeschwindigkeit der dispersen Phase [mm/s]', x_label = 'Tropfengröße [mm]',title = VERWENDETE_DATEN, SAVE_DIR = ROOT_DIR + "\\datasets\\output_analyseddata\\" + VERWENDETE_DATEN + "\\v_y_positive_negative_all_anzahl_tropfen\\v_y"+VERWENDETE_DATEN)
...
def plot_geschwindigkeitsverteilung(dict, größe, max_anzahl):
    ...
    ax.set_xlabel('Geschwindigkeit [mm/s]', fontsize = 18, fontname = "Arial")
    ax.set_ylabel('Anzahl ID aus dic_id', fontsize = 18, fontname = "Arial")
    ax.set_title(VERWENDETE_DATEN, fontsize = 18, fontname = "Arial")
    plt.xticks(rotation=45, ha='right', fontsize = 18, fontname = "Arial")
    ...
    #done
    plt.text(0.9, max_anzahl * 0.85, "Summe Anzahl ID aus dic_id: " + str(gesamt_anzahl_tropfen))
...
def plot_rgb_v_y_gekuertzt(list_v_y, zeit):
    ...
    ax1.set_xlabel('Zeit [s]', fontsize = 18, fontname = "Arial")
    ax1.set_ylabel('RGB-Farbwert', color='b', fontsize = 18, fontname = "Arial")
    ...
    ax2.set_ylabel('Aufstiegsgeschwindigkeit der dispersen Phase [mm/s]', color='k', fontsize = 18, fontname = "Arial")
    ax2.set_ylim([-40, 80])
    ...
    ax2.set_title(VERWENDETE_DATEN, fontsize = 18, fontname = "Arial")
...
def plot_phasenverschiebung():
    ...
    plot_bar(loc_label = "upper left", label = None, pos_string = [], strings = [], x_achse = list_verwendete_daten, y_achse = list_phasenverschiebung_in_degree, y_modell = None, y_label = 'Phasenverschiebung [°]', x_label = 'Datensätze',title = "Phasenverschiebung zwischen Aufstiegsgeschwindigkeit und RGB-Farbwert in Grad", SAVE_DIR =ROOT_DIR+"\\datasets\\output_analyseddata\\phasenverschiebung.png")
...
def länge_eine_folge():
    ...
    for größe in dic_id_groeßenverteilung:
        ...
        plot_bar(loc_label = "upper left", label = None, pos_string = None, strings = [], x_achse = list_laenge_ids, y_achse = anzahl_ids, y_modell = None, y_label = "Anzahl ID aus dic_id", x_label = "Länge ID aus dic_id", title = VERWENDETE_DATEN, SAVE_DIR = ROOT_DIR + "\\datasets\\output_analyseddata\\" + VERWENDETE_DATEN + "\\langeids\\langeids_" + str(größe) + "_" + VERWENDETE_DATEN + ".png")
    ...
    plot_bar(loc_label = "upper left", label = None, pos_string = None, strings = [], x_achse = list_laenge_ids, y_achse = anzahl_ids, y_modell = None, y_label = "Anzahl ID aus dic_id", x_label = "Länge ID aus dic_id", title = VERWENDETE_DATEN, SAVE_DIR = ROOT_DIR + "\\datasets\\output_analyseddata\\" + VERWENDETE_DATEN + "\\langeids\\langeids_alle_groeßen_" + VERWENDETE_DATEN + ".png") 
    ...
    plot_bar(loc_label = "upper left", label = None, pos_string = None, strings = [], x_achse = x, y_achse = länge_list[0:-1], y_modell = None, y_label = "Durchschnittliche Länge einer ID aus dic_id", x_label = "Tropfengröße [mm]", title = VERWENDETE_DATEN, SAVE_DIR = ROOT_DIR + "\\datasets\\output_analyseddata\\" + VERWENDETE_DATEN + "\\länge_ids_"+VERWENDETE_DATEN)
...
def Volumenanteil_pro_groeßenklasse():
    ...
    for i in range(len(tropfengröße)):
        if tropfengröße[i] != np.inf:
            ...
            string = str(tropfengröße[i-1])+ " bis " + str(tropfengröße[i])
        x.append(string)
    plot_bar(loc_label = "upper left",label = None, pos_string = None, strings = [], x_achse = x, y_achse = v_rel[:-1], y_modell = None, y_label = "Relativer Volumenanteil [%]", x_label = "Tropfengröße [mm]", title = VERWENDETE_DATEN, SAVE_DIR = ROOT_DIR + "\\datasets\\output_analyseddata\\" + VERWENDETE_DATEN + "\\relativer_volumenanteil_"+VERWENDETE_DATEN)
...
def laenge_datensatz():
    ...
    plot_bar(loc_label = "upper left",label = None, pos_string = None, strings = [], x_achse = list_verwendete_daten, y_achse = list_zeitdifferenz, y_modell = None, y_label = "Zeit [ms]", x_label = "Datensatz", title = "Länge der Datensätze", SAVE_DIR = ROOT_DIR+"\\datasets\\output_analyseddata\\länge_datensätze.png")
...
def exponent_parametrisierung():
    ...
    for i, VERWENDETE_DATEN in enumerate(list_verwendete_daten):
        if VERWENDETE_DATEN.split("_")[4] != "100":
            ...
            list_plot_exponent.append(VERWENDETE_DATEN)
            print(n, VERWENDETE_DATEN)
            list_n.append(n)
    plot_bar(loc_label = "upper left",label = None, pos_string = None, strings = [], x_achse = list_plot_exponent, y_achse = list_n, y_modell = None, y_label = "Schwarmexponent n", x_label = "Datensatz", title = "Schwarmexponent n von Datensätzen", SAVE_DIR = ROOT_DIR+"\\datasets\\output_analyseddata\\exponent_n.png")
...
def berechne_verhältnis_anzahl_tropfen():
    ...
    plot_bar(loc_label = "upper left",label = None, pos_string = None, strings = [], x_achse = x, y_achse = verhältnis, y_modell = None, y_label = "anzahl durch anzahl", x_label = "Tropfengröße [mm]", title = VERWENDETE_DATEN, SAVE_DIR = ROOT_DIR + "\\datasets\\output_analyseddata\\" + VERWENDETE_DATEN + "\\anzahl_durch_anzahl"+VERWENDETE_DATEN)

 

modus = int(input("modus = 0: Tropfenerkennung für Datensatz, modus = 1: Tropfenverfolgung - erstellung von dic_id (Vorrausetzung modus 0 muss schon einmal gelaufen sein für den Datensatz), modus = 2: Datenanalyse (Vorrausetzung: modus 0 und 1 muss schon gelaufen sein für den Datensatz), modus = 3: modus 0 bis 2 werden hintereinander durchlaufen, modus = 4: modus 1 bis 2 werden hintereinander durchlaufen \n"))
if modus == 0:
    list_modus = [0]
if modus == 1:
    list_modus = [1]
...
"""
#V:\Messdaten\Masterarbeit hegr02\Studentische Arbeiten\MA_abgabe_JoRo\01_Literature

MIT KONSOLE LAUFEN LASSEN. -> Bessere Leistung
python C:\\Users\\stefa\\Desktop\\BA_git\\mrcnn-pse\\01_Mask_R_CNN\\skripte\\konsekuitive_bilderkennung_umgedrehtes_koordinatensystem.py
...
"""
1. Tracking von Tropfen über mehrere Bilder hinweg
    a. Speicherstruktur muss überlegt werden    
2. Strukturierte Datenablage überlegen
    ...
    b. Stationaerer d32                                         
3. Datenanalyse
    a. Geschwindigkeit je Tropfenklasse                         
    b. Geschwindigkeit waehrend einer Periode                 
    c. Negative/positive Geschwindigkeiten                  
