...
def konsekutive_bilderverfolgung():
    ...
    pickle.dump(list_komb, open(ROOT_DIR+"\\daten\\vorgaenger_nachfolger_beziehung_"+VERWENDETE_DATEN, "wb"))
...
python C:\\Users\\stefa\\Desktop\\BA_git\\mrcnn-pse\\01_Mask_R_CNN\\skripte\\konsekuitive_bilderkennung_optimiert.py
