...
def konsekutive_bilderverfolgung():
    ...
    for bild_index in range(start, ende):
        ...
        alle_vorgänger_nachfolger_beziehungen_mit_mehreren_potentiellen_nachfolgern = []
        #List_second = alle_vorgänger_nachfolger_beziehungen_mit_mehreren_potentiellen_nachfolgern
        alle_potentiellen_vorgänger_nachfolger_beziehungen_außer_ein_vorgänger_mehrere_potentielle_nachfolger = []
        for i, elem in enumerate(alle_potentiellen_vorgänger_nachfolger_beziehungen):               
            if len(elem) > 2:
                alle_vorgänger_nachfolger_beziehungen_mit_mehreren_potentiellen_nachfolgern.append(elem)
            else:
                alle_potentiellen_vorgänger_nachfolger_beziehungen_außer_ein_vorgänger_mehrere_potentielle_nachfolger.append(elem)
                
        list_tasaelicher_nachfolger = []
        for i, elem in enumerate(alle_vorgänger_nachfolger_beziehungen_mit_mehreren_potentiellen_nachfolgern):
            vorgaenger = elem[0]
            list_abweichung = []
        ...
        dic_droplet = alle_potentiellen_vorgänger_nachfolger_beziehungen_außer_ein_vorgänger_mehrere_potentielle_nachfolger + list_tasaelicher_nachfolger
        ...
        #list_tatsaechlicher_vorgaenger = wahrscheinlichsten_vorgänger_nachfolger_beziehungen 
