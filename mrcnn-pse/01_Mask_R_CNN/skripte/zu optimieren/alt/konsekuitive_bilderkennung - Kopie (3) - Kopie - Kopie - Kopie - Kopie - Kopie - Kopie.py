...
def konsekutive_bilderverfolgung():
    dic_id, id_counter, alle_potentiellen_vorgänger_nachfolger_beziehungen = {}, 0, []
    ...
    for bild_index in range(start, ende):
        ...
        alle_potentiellen_VNB_außer_ein_vorgänger_mehrere_potentielle_nachfolger = [elem for elem in alle_potentiellen_vorgänger_nachfolger_beziehungen if len(elem) > 2]
        ...
        for i, elem in enumerate(alle_potentiellen_vorgänger_nachfolger_beziehungen_außer_ein_vorgänger_mehrere_potentielle_nachfolger):
            vorgaenger = elem[0]
            list_abweichung = []
        ...
        #VNB    = VORGÄNGER NACHFOLGER BEZIEHUNG
            
        wahrscheinlichste_VNB_wenn_vorgänger_mehrere_nachfolger_und_alle_potentiellen_VNB_wenn_nachfolger_mehrere_potentielle_vorgänger_hat =  alle_potentiellen_VNB_außer_ein_vorgänger_mehrere_potentielle_nachfolger + list_tasaelicher_nachfolger
        List = []
        for i, elem in enumerate(wahrscheinlichste_VNB_wenn_vorgänger_mehrere_nachfolger_und_alle_potentiellen_VNB_wenn_nachfolger_mehrere_potentielle_vorgänger_hat):
            if len(elem) == 2 and elem[1] not in List:
                List.append(elem[1])                

        wahrscheinlichsten_vorgänger_nachfolger_beziehungen = []
        for i, nachfolger in enumerate(List):
            List_potentieller_vorgaenger = []
            for ii, elemelem in enumerate(wahrscheinlichste_VNB_wenn_vorgänger_mehrere_nachfolger_und_alle_potentiellen_VNB_wenn_nachfolger_mehrere_potentielle_vorgänger_hat):
                if nachfolger == elemelem[-1]:
        ...
        wahrscheinlichste_vorgänger_nachfolger_beziehungen_wenn_vorgänger_mehrere_nachfolger_und_alle_potentiellen_vorgänger_nachfolger_beziehungen_wenn_nachfolger_mehrere_potentielle_vorgänger_hat = []
        alle_potentiellen_vorgänger_nachfolger_beziehungen = []
        wahrscheinlichsten_vorgänger_nachfolger_beziehungen = []
        alle_potentiellen_vorgänger_nachfolger_beziehungen_außer_ein_vorgänger_mehrere_potentielle_nachfolger = []
